...
class Page
{
    ...
    function displayHome ()
    {
        ...
        echo '
                ...
                <p>
					<a href="https://facebook.com/cybermcjim" target="_blank">'.T_('www.facebook.com/cybermcjim').'</a><br>
					<a href="https://facebook.com/jcmcyberworks" target="_blank">'.T_('www.facebook.com/jcmcyberworks').'</a>
				</p>';
        $this->displayFooter();
    }
