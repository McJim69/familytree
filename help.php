...
class Page
{
    ...
    function displayHome ()
    {
        ...
        echo '
                ...
                <p>'.T_('Check out the webmaster page for more help.').'</p>
                <p>
					<a href="https://mcjim-server.com" target="_blank">'.T_('www.mcjim-server.com').'</a><br>
					<a href="https://mcjim-server.com" target="_blank">'.T_('admin@mcjim-server.com').'</a>
				</p>';
        $this->displayFooter();
    }
    ...
    function displayPhotoGallery ()
    {
        ...
        echo '
            ...
            <hr style="margin: 20px 0; border: none; border-top: 1px solid var(--border-color, #3b4252);" />

            <a id="gallery-howworks"></a>
