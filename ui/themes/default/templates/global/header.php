...
<link rel="stylesheet" type="text/css" href="<?php echo $TMPL['path']; ?>ui/themes/default/css/style.css?version=430"/>
<link rel="stylesheet" type="text/css" href="<?php echo $TMPL['path']; ?>ui/themes/default/css/mobile.css?version=430"/>
        ...
        <div class="header-inner container">
            ...
            <div class="user-meta-bar">
                ...
                <div class="user-actions">
                    <button type="button" id="theme-toggle-btn" class="btn-user-action btn-theme-toggle" aria-label="Toggle Theme">
